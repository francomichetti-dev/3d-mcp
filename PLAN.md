...
- Hold the state lock across the re-exec **and** the carried-attribute restore, so a job completing on the main thread can never observe a half-rebuilt module dict.
